    ...
    <div class="input-group">
        <label type="checkbox">
            <input type="checkbox" name="registration_enabled" value="1" <?php echo \Config::get(
                'auth.linkedin.registration.enabled',
                false) ? 'checked' : '' ?>>
    ...
    <select name="registration_group" class="form-control">
        ...
        foreach ($groups as $group) {
            ...
            <option value="<?php echo $group->getGroupID() ?>" <?php echo intval($group->getGroupID(), 10) === intval(
                \Config::get('auth.linkedin.registration.group', false),
                10) ? 'selected' : '' ?>>
...
<p><?php echo t(
        'Linkedin allows accounts be created against custom domains like "example.com". ' .
...
<div class="alert alert-info">
    <?php echo t(
        ...
        'https://console.developers.linkedin.com/project'); ?>
</div>
