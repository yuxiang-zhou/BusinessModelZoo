...
if (isset($blockTypes) && !empty($blockTypes)) {
    ...
    <div class="alert alert-info">
        <i class="fa fa-info"></i> <?php  echo t('Click on a desired block type to load the config into the block designer form.'); ?>
    </div>

    <ul class="item-select-list"><?php  echo implode('', $li); ?></ul><?php 
} else {
    ?>
    <div class="alert alert-info">
