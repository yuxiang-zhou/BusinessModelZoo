...
<div class="content-field-options">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="fields[{{id}}][disallow_float]">
            ...
            <div class="form-group">
                <label for="fields[{{id}}][number_format]">
            ...
            <div class="form-group number-formatting hidden">
                <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="alert alert-warning hidden alert-floats" style="margin-top:15px;">
                <?php  echo t('You can not enter floating numbers on the fields above, as the box "disallow float number" has been checked.'); ?>
            </div>
        </div>
    </div>
</div>
