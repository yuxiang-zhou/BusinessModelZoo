...
<div class="content-field-options">
    <div class="form-group">
        <div class="row">
            <div class="col-sm-4">
                <label for="fields[{{id}}][size]"><?php  echo t('Video size'); ?></label>
            ...
            <div class="col-sm-8">
                <div class="youtube_values hidden">
                    <div class="row">
                        <div class="col-sm-6">
                            <label for="fields[{{id}}][width]"><?php  echo t('Width'); ?></label>
                        ...
                        <div class="col-sm-6">
                            <label for="fields[{{id}}][height]"><?php  echo t('Height'); ?></label>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="fields[{{id}}][cc_load_policy]">
                ...
                <div class="form-group">
                    <label for="fields[{{id}}][iv_load_policy]">
