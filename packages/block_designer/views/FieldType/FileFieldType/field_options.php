...
<div class="content-field-options">
    <div class="form-group">
        <label for="fields[{{id}}][link_class]" class="control-label">
            <?php  echo t('Class(es)'); ?>
            <small><?php  echo t('Class(es) to be added to your link'); ?></small>
        </label>
    ...
    <div class="form-group">
        ...
        <label for="fields[{{id}}][url_target]"><?php  echo t('Link opens in a new window'); ?></label>
    </div>

    <div class="form-group">
        <label for="fields[{{id}}][title_field]">
    ...
    <div class="form-group title_field-values hidden">
        <label for="fields[{{id}}][title_field_required]">
