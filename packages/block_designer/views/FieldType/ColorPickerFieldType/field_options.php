            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label>
                        ...
                        <br/><small><?php  echo t('Value can be cleared by clicking a "Clear Color Selection" button'); ?></small>
                    </label>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="fields[{{id}}][clear_text]" class="control-label">
                        <?php  echo t('"Clear Color Selection" text'); ?>
                    </label>
                ...
                <div class="form-group">
                    <label for="fields[{{id}}][no_color_selected_text]" class="control-label">
                        <?php  echo t('"No Color Selected" text'); ?>
                    </label>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label>
                        ...
                        <br/><small><?php  echo t('requires "Show a palette"'); ?></small>
                    </label>
                </div>
