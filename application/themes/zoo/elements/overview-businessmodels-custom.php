							...
							<div class="relative_z-1 yellow colored">
								...
								<div class="text-headline">
									...
									<div class="text-common">
										<?php
											$a = new Area('Product model categorie text-a');
											$a->display($c);
										?>
									</div>
								</div>
						...
						<div class="col-xs-6">
							<div class="relative_z-1 orange colored">
								...
								<div class="text-headline">
									...
									<div class="text-common">
										<?php
											$a = new Area('Solutions model categorie text-a');
											$a->display($c);
										?>
									</div>
								</div>
						...
						<div class="col-xs-6">
							<div class="relative_z-1 blue colored">
								...
								<div class="text-headline">
									...
									<div class="text-common">
										<?php
											$a = new Area('Matchmaking categorie text-a');
											$a->display($c);
										?>
									</div>
								</div>
						...
						<div class="col-xs-6">
							<div class="relative_z-1 green colored">
								...
								<div class="text-headline">
									...
									<div class="text-common">
										<?php
											$a = new Area('Multi-sided categorie text-a');
											$a->display($c);
										?>
									</div>
								</div>
